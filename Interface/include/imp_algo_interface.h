...
* 配置VFD
* @param hModule 模块句柄
* @param pstVfdParaSrc  输入参数
* @return IMP_BOOL 操作状态
*/
IMP_EXPORTS IMP_BOOL IMP_VFD_ConfigParameter(IMP_HANDLE hModule, IMP_VFD_PARA_S *pstVfdParaSrc);
/**
* 处理VFD
* @param hModule 模块句柄
* @param pYRaw8  输入的灰度图像
* @param u32Width  输入图像的宽度
* @param u32Height 输入图像的高度
* @return IMP_BOOL 操作状态
*/
