...
{
	IMP_U32 u32Enable;			///< 亮度异常检测功能开关，0为关闭，1为开启，默认为1
	...
	IMP_U32 u32BHUsrNmThrd1;	///< 过亮检测可见光模式下用户自定义双阈值第1阈值，默认为30
	IMP_U32 u32BHUsrNmThrd2;	///< 过亮检测可见光模式下用户自定义双阈值第2阈值，默认为60
	IMP_U32 u32BHUsrIrThrd1;	///< 过亮检测红外模式下用户自定义双阈值第1阈值，默认为30
	IMP_U32 u32BHUsrIrThrd2;	///< 过亮检测红外模式下用户自定义双阈值第2阈值，默认为60
	IMP_U32 u32BLUsrNmThrd1;	///< 过暗检测可见光模式下用户自定义双阈值第1阈值，默认为30
	IMP_U32 u32BLUsrNmThrd2;	///< 过暗检测可见光模式下用户自定义双阈值第2阈值，默认为60
	IMP_U32 u32BLUsrIrThrd1;	///< 过暗检测红外模式下用户自定义双阈值第1阈值，默认为30
	IMP_U32 u32BLUsrIrThrd2;	///< 过暗检测红外模式下用户自定义双阈值第2阈值，默认为60
}IMP_AVD_BRIGHT_ABMNL_PARA_S;

typedef struct impAVD_CLARITY_PARA_S
{
	IMP_U32 u32Enable;			///< 清晰度检测功能开关，0为关闭，1为开启，默认为1
	...
	IMP_U32 u32UsrNmThrd1;		///< 清晰度检测可见光模式下用户自定义双阈值第1阈值，默认为30
	IMP_U32 u32UsrNmThrd2;		///< 清晰度检测可见光模式下用户自定义双阈值第2阈值，默认为60
	IMP_U32 u32UsrIrThrd1;		///< 清晰度检测红外模式下用户自定义双阈值第1阈值，默认为30
	IMP_U32 u32UsrIrThrd2;		///< 清晰度检测红外模式下用户自定义双阈值第2阈值，默认为60
}IMP_AVD_CLARITY_PARA_S;

typedef struct impAVD_NOISE_PARA_S
{
	IMP_U32 u32Enable;			///< 噪声检测功能开关，0为关闭，1为开启，默认为1
	...
	IMP_U32 u32UsrNmThrd1;		///< 噪声检测可见光模式下用户自定义双阈值第1阈值，默认为30
	IMP_U32 u32UsrNmThrd2;		///< 噪声检测可见光模式下用户自定义双阈值第2阈值，默认为60
	IMP_U32 u32UsrIrThrd1;		///< 噪声检测红外模式下用户自定义双阈值第1阈值，默认为30
	IMP_U32 u32UsrIrThrd2;		///< 噪声检测红外模式下用户自定义双阈值第2阈值，默认为60
...
typedef struct impAVD_COLOR_PARA_S
{
	...
	IMP_U32 u32UsrNmThrd1;		///< 偏色检测可见光模式下用户自定义双阈值第1阈值，默认为30
	IMP_U32 u32UsrNmThrd2;		///< 偏色检测可见光模式下用户自定义双阈值第2阈值，默认为60
	IMP_U32 u32UsrIrThrd1;		///< 偏色检测红外模式下用户自定义双阈值第1阈值，默认为30
	IMP_U32 u32UsrIrThrd2;		///< 偏色检测红外模式下用户自定义双阈值第2阈值，默认为60
