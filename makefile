...
PEA_OBJS := AlgoModule/ALGO_PARA/Para/imp_para.o AlgoModule/GA/CommonAlgo/Common/imp_ga_carray.o \
			...
			AlgoModule/PEA/code/ObjRecognition/Detector/imp_vibe_bgmodel_ive.o \
