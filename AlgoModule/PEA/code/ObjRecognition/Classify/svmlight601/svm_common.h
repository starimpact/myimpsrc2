...
typedef struct svector {
  WORDSVM    *words;              /* The features/values in the vector by
...
SVECTOR *create_svector(WORDSVM *, char *, double);
...
int    parse_document(char *, WORDSVM *, double *, long *, long *, double *, long *, long, char **);
