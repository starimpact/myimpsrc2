...
void TDE_OUTPUT_PEA_RESULT(TDE_HANDLE s32Handle, TDE2_SURFACE_S* pstDst,RESULT_S *result)//,TDE2_IMP_RECT_S *pstDstRect)
{
 ...
 //   printf("s32Xpos:%d,s32Ypos:%d,u32Width:%d,u32Height:%d\n",pstDstRect.s32Xpos,pstDstRect.s32Ypos,pstDstRect.u32Width,pstDstRect.u32Height);
    ...
    rc1.s16X1 = stURPpara.stRuleSet.astRule[0].stPara.stPerimeterRulePara.stLimitPara.stBoundary.astBoundaryPts[0].s16X;
	rc1.s16Y1 = stURPpara.stRuleSet.astRule[0].stPara.stPerimeterRulePara.stLimitPara.stBoundary.astBoundaryPts[0].s16Y;
	rc1.s16X2 = stURPpara.stRuleSet.astRule[0].stPara.stPerimeterRulePara.stLimitPara.stBoundary.astBoundaryPts[2].s16X;
	rc1.s16Y2 = stURPpara.stRuleSet.astRule[0].stPara.stPerimeterRulePara.stLimitPara.stBoundary.astBoundaryPts[2].s16Y;
